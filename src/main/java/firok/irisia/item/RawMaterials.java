...
public class RawMaterials
{
	...
	public final static InformationItem DarkMetalIngot;
	public final static InformationItem VibrhythmMetalIngot;
	public final static InformationItem LuxMetalIngot;
	public final static InformationItem StormMetalIngot;
	public final static InformationItem PhotosynthesisMetalIngot;
	...
	static
	{
		...
		DarkMetalIngot =new InformationItem(uncommon);
		VibrhythmMetalIngot =new InformationItem(uncommon);
		LuxMetalIngot =new InformationItem(uncommon);
		StormMetalIngot =new InformationItem(uncommon);
		PhotosynthesisMetalIngot=new InformationItem(uncommon);
